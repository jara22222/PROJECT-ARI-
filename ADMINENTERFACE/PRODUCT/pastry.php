        ...
        <div class="container menu-container">
            <ul>
                ...
                <li class="dropdown" onclick="toggleDropdown(this)">
                    ...
                    <li><a class="text-truncate" href="coffee.php" onclick="event.stopPropagation();">Add coffee</a></li>
                    <li><a class="text-truncate" href="pastry.php" onclick="event.stopPropagation();">Add pastry</a></li>
                    <li><a class="text-truncate" href="rice_meal.php" onclick="event.stopPropagation();">Add rice meal</a></li>
                    </ul>
                </li>
            ...
            <!--Coffee-->
                ...
                <div class="container my-4">
                        ...
                        <div class="container mt-5 d-flex">
                            <div class="col-md-6"> <p class="display-5 fw-bold">Pastry</p>
                            </div>
